...
export declare namespace IOracle {
  ...
  export type RoundDataStructOutput = [
    ...
    timestamp: bigint,
    success: boolean
  ] & { round: bigint; price: bigint; timestamp: bigint; success: boolean };
}
...
export interface OracleInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "NewRound" | "NewSymbols" | "Voted"
  ): EventFragment;
  ...
  encodeFunctionData(
    functionFragment: "getVotePeriod",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "getVoters", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "lastRoundBlock",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "lastVoterUpdateRound",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setSymbols",
    values: [string[]]
  ): string;
  encodeFunctionData(
    functionFragment: "setVoters",
    values: [AddressLike[]]
  ): string;
  encodeFunctionData(
    functionFragment: "symbolUpdatedRound",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace NewSymbolsEvent {
  export type InputTuple = [_symbols: string[], _round: BigNumberish];
  export type OutputTuple = [_symbols: string[], _round: bigint];
  export interface OutputObject {
    _symbols: string[];
    _round: bigint;
  }
...
export interface Oracle extends BaseContract {
  ...
  getRoundData: TypedContractMethod<
    [_round: BigNumberish, _symbol: string],
  ...
  vote: TypedContractMethod<
    [_commit: BigNumberish, _reports: BigNumberish[], _salt: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "getVotePeriod"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "getVoters"
  ): TypedContractMethod<[], [string[]], "view">;
  getFunction(
    nameOrSignature: "lastRoundBlock"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "lastVoterUpdateRound"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "setSymbols"
  ): TypedContractMethod<[_symbols: string[]], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setVoters"
  ): TypedContractMethod<[_newVoters: AddressLike[]], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "symbolUpdatedRound"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "symbols"
  ): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  getFunction(
  ...
  getEvent(
    ...
    NewSymbolsEvent.InputTuple,
    NewSymbolsEvent.OutputTuple,
    NewSymbolsEvent.OutputObject
  >;
  getEvent(
    key: "Voted"
  ): TypedContractEvent<
  ...
  filters: {
    "NewRound(uint256,uint256,uint256,uint256)": TypedContractEvent<
      NewRoundEvent.InputTuple,
      NewRoundEvent.OutputTuple,
      NewRoundEvent.OutputObject
    >;
    ...
    "NewSymbols(string[],uint256)": TypedContractEvent<
      NewSymbolsEvent.InputTuple,
      NewSymbolsEvent.OutputTuple,
      NewSymbolsEvent.OutputObject
    >;
    NewSymbols: TypedContractEvent<
      NewSymbolsEvent.InputTuple,
      NewSymbolsEvent.OutputTuple,
      NewSymbolsEvent.OutputObject
    >;

    "Voted(address,int256[])": TypedContractEvent<
      VotedEvent.InputTuple,
      VotedEvent.OutputTuple,
      VotedEvent.OutputObject
    >;
